    ...
    <>
      ...
      <section className="px-[10px] py-[25px] bg-zinc-100">
        <div className="py-[25px] max-w-[900px] mx-auto">
          ...
          <p className="text-zinc-500">Llena el siguiente formulario y uno de nuestros mentores se pondrá en contacto contigo en base a tus necesidades.</p>
        </div>
        <form className="flex flex-col justify-center max-w-[900px] mx-auto">
          ...
          <textarea id="message" name="message" placeholder="Escriba su mensaje" className="w-full h-[100px] border-[1px] border-zinc-300 py-[10px] px-[5px] resize-none mb-[20px] rounded-[5px]"></textarea>
